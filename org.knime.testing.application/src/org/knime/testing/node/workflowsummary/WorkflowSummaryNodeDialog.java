 ...
 */
class WorkflowSummaryNodeDialog extends DefaultNodeSettingsPane {

    private DialogComponentStringListSelection m_dc;

    WorkflowSummaryNodeDialog() {
    ...
    private static Collection<String> getNodes() {
        ...
        if (wfm != null) {
            return wfm.getNodeContainers().stream()
                .map(nc -> nc.getName() + "(#" + NodeIDSuffix.create(wfm.getID(), nc.getID()) + ")")
    ...
    public void loadAdditionalSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs)
        ...
        m_dc.replaceListItems(getNodes());
    }
