...
public final class XmlDifferNodeFactory extends WebUINodeFactory<XmlDifferNodeModel> {
    ...
    private static final WebUINodeConfiguration CONFIG = WebUINodeConfiguration.builder()//
        .name("XML Differ") //
        .icon("./icon.png") //
        .shortDescription("Computes differences between two XML values.") //
        .fullDescription("""
                This node computes differences between two XML values. One value acts as a control value to which the
                other value is compared to.
                ...
                """.formatted(XmlDifferCellFactory.Columns.SUMMARY.getName()))
