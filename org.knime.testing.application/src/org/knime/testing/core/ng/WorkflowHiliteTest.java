...
public class WorkflowHiliteTest extends WorkflowTest {
    ...
    private void hiliteRows(final TestResult result, final WorkflowManager manager,
        ...
        for (NodeContainer cont : manager.getNodeContainers()) {
            if (cont instanceof WorkflowManager) {
                hiliteRows(result, (WorkflowManager)cont, flowConfiguration);
            } else if (cont instanceof SingleNodeContainer) {
                hiliteRows(result, (SingleNodeContainer)cont, flowConfiguration);
