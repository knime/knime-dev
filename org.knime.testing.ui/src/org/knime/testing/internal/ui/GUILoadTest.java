...
class GUILoadTest extends WorkflowTest {
    ...
    static UIWorkflowManager loadWorkflow(final WorkflowTest test, final TestResult result, final File workflowDir,
        ...
        UIWorkflowManager manager = WorkflowManagerWrapper.wrap(loadRes.getWorkflowManager());
        ...
        Display.getDefault().syncExec(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    ProjectWorkflowMap.putUIWorkflow(workflowDir.toURI(), manager);
