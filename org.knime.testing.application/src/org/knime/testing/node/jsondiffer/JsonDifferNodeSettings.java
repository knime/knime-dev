...
/**
 * Settings class for the JsonDiffer node.
 *
 * @author
 */
final class JsonDifferNodeSettings implements DefaultNodeSettings {
    ...
    interface DialogSections {
        ...
        @Section(title = "B")
        @After(DialogSections.A.class)
        interface B {
        }

    }

    @Layout(DialogSections.A.class)
    @Widget(title = "Target Column", description = "Choose a column")
    ...
    @Layout(DialogSections.B.class)
    @Widget(title = "Mode", description = """
            ...
            """)
    @ValueSwitchWidget
    Option m_option = Option.O;
